        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proportions_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Proportions_Pizzas_PizzaId",
                        column: x => x.PizzaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PizzaId = table.Column<int>(nullable: false),
                    PizzamakerId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PizzaOrders_Users_PizzamakerId",
                        column: x => x.PizzamakerId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PizzaOrders_PizzamakerId",
                table: "PizzaOrders",
                column: "PizzamakerId");

            migrationBuilder.CreateIndex(
                name: "IX_Proportions_IngredientId",
                table: "Proportions",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_Proportions_PizzaId",
                table: "Proportions",
                column: "PizzaId");
        }
